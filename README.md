...
🔗 **Live App:** [your-username.github.io/unstuck](https://your-username.github.io/unstuck)  
...
Early version used an AI API. Removed it for v2 because: (1) offline requirement, (2) latency broke the "get unstuck now" feeling, (3) 80+ hand-crafted challenges across 8 moods × 3 intensities gave more consistent quality and zero cost.

**Why sound?**  
Each interaction has a distinct sound. The sprint completion plays a full musical arpeggio. Sound creates a **multisensory habit signal** — over time, the completion sound becomes a conditioned reward that reinforces daily return.
...
**v2 — Deepen the habit**
- [ ] Push notifications with streak reminders (Web Push API)
- [ ] Weekly reflection prompt every Sunday
- [ ] "Challenge history" — never repeat a challenge until you've done all of them

**v3 — Community layer**
- [ ] Optional "show your sprint" — share what you made in 5 minutes (anonymous)
- [ ] Community-submitted challenges (curated)
- [ ] Friend streaks

**v4 — Platform expansion**
- [ ] Native iOS/Android (React Native)
- [ ] Slack integration — `/unstuck` command for teams
- [ ] Corporate wellness API for B2B
...
**Background:** I'm transitioning from 5+ years as a Windows Systems Administrator into Product Management. This project draws on real observations from working in high-stress IT operations environments — where people are constantly context-switching, alert-fatigued, and never taught how to reset.

---

*Built by [Your Name] · [linkedin.com/in/yourprofile](https://linkedin.com) · [your@email.com](mailto:your@email.com)*
